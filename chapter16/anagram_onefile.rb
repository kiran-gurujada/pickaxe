...
##### Read and convert the dictionary #####


# convert "wombat" into "abmotw". All anagrams share a common signature
...
##### Look up each command line argument and report the result #####
